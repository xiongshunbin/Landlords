...
PROTOBUF_NAMESPACE_OPEN
template<> ::Dabing::Address* Arena::CreateMaybeMessage<::Dabing::Address>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Dabing {
...
class Address final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Dabing.Address) */ {
 public:
