...
const uint32_t TableStruct_Address_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Dabing::Address, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Dabing::Address, _impl_.num_),
  PROTOBUF_FIELD_OFFSET(::Dabing::Address, _impl_.addr_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Dabing::Address)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Dabing::_Address_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_Address_2eproto = {
    false, false, 69, descriptor_table_protodef_Address_2eproto,
    "Address.proto",
...
Address::Address(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:Dabing.Address)
}
...
template<> PROTOBUF_NOINLINE ::Dabing::Address*
Arena::CreateMaybeMessage< ::Dabing::Address >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Dabing::Address >(arena);
}
